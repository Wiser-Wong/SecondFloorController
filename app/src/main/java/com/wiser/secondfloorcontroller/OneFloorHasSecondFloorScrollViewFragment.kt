...
class OneFloorHasSecondFloorScrollViewFragment : Fragment() {

    companion object {
        fun newInstance(): OneFloorHasSecondFloorScrollViewFragment {
            return OneFloorHasSecondFloorScrollViewFragment()
        }
    }
...
//        parentFragment()?.getController()?.setOverlapDistance(0)
    ...
    fun parentFragment(): OneFloorHasSecondFloorFragment? {
        if (this@OneFloorHasSecondFloorScrollViewFragment.parentFragment is OneFloorHasSecondFloorFragment) {
            return (this@OneFloorHasSecondFloorScrollViewFragment.parentFragment as OneFloorHasSecondFloorFragment)
        }
        return null
    }
}
