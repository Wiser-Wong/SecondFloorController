...
class OneFloorNoSecondFloorRecyclerViewFragment : Fragment() {

    companion object {
        fun newInstance(): OneFloorNoSecondFloorRecyclerViewFragment {
            return OneFloorNoSecondFloorRecyclerViewFragment()
        }
    }
...
//        parentFragment()?.getController()?.setOverlapDistance(0)
    ...
    fun parentFragment(): OneFloorNoSecondFloorFragment? {
        if (this@OneFloorNoSecondFloorRecyclerViewFragment.parentFragment is OneFloorNoSecondFloorFragment) {
            return (this@OneFloorNoSecondFloorRecyclerViewFragment.parentFragment as OneFloorNoSecondFloorFragment)
        }
        return null
    }
}
